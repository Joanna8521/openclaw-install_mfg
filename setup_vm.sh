...
echo ""
echo -e "  ${CYAN}curl -fsSL https://raw.githubusercontent.com/Joanna8521/openclaw-install_mfg/main/bootstrap.sh -o bootstrap.sh && chmod +x bootstrap.sh && sudo ./bootstrap.sh${RESET}"
echo ""
